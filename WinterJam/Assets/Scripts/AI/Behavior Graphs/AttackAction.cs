    ...
    protected override Status OnUpdate()
    {
        ...
        else
        {
            ...
            if (distanceMagnitude > 100f)
            {
                ...
                Enemy.Value.enemyController.SetDestination(Player.Value.transform.position);
            }
            ...
            else
            {
                ...
                {
                    Enemy.Value.enemyAnimator.SetAnimationBool("isStrafe", true);
                    //Gets normalized value between for 0-1 animation value
                    float normalizedDir = Mathf.InverseLerp(90f, -90f, targetAngle);
                    Enemy.Value.enemyAnimator.SetAnimationStrafeDirection(normalizedDir);
                    ...
                    Enemy.Value.enemyController.SetDestination(strafePosition);
